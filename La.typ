...
#grid(
  ...
  [diligere], [lieben, hochschätzen], [_diligo_, _dilexi_, _dilectum_],
  [gaudium], [Freude], [_gaudii_ n.],
  [cognoscere], [erkennen, kennenlernen], [_cognosco_, _cognovi_, _cognitum_],
  [frugalitas], [Sparsamkeit, Genügsamkeit], [_frugalitatis_ f.],
  [amare], [lieben], [_amo_, _amavi_, _amatum_],
  [legere], [lesen], [_lego_, _legi_, _lectum_],
  ...
  [creditum], [Darlehen, Schuld, Kredit], [_crediti_ n.],
  [saepe], [oft], [],
